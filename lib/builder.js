    ...
    Builder.prototype.buildObject = function(rootObj) {
      ...
      render = (function(_this) {
        return function(element, obj) {
          var attr, child, children_as_array, entry, entryStr, index, key, name, value;
          if (typeof obj !== 'object') {
            ...
            if ((obj != null) && charkey in obj && !(_this.options.charsAsChildren && childkey in obj)) {
              child = obj[charkey];
              ...
              if (Array.isArray(child)) {
                ...
                for (index in child) {
                  ...
                  if (typeof entry === "object") {
                    if ('#name' in entry && entry['#name'] === '__text__') {
                      entryStr = entry[charkey];
                      if (_this.options.cdata && requiresCDATA(entryStr)) {
